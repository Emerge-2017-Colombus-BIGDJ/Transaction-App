...
public class PurchaseViewSimplest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras().getInt("item") == 0)
            setContentView(R.layout.purchase_view_main_simplest);
        else
            setContentView(R.layout.purchase_view_main_simplest1);
